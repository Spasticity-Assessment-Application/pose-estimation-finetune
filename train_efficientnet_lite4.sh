...
###############################################################################
# Script d'entraînement EfficientNetLite4 avec modifications minimales
...
echo "=========================================="
echo "🚀 ENTRAÎNEMENT EFFICIENTNETLITE4"
echo "=========================================="

# Configuration
BACKBONE="EfficientNetLite4"
IMAGE_SIZE=300  # Taille recommandée pour EfficientNetLite4
HEATMAP_SIZE=100  # Proportionnel: 300/192 * 64 ≈ 100
...
echo "=========================================="
echo ""
echo "💡 Résultats sauvegardés dans: output/ENL4_YYYYMMDD_HHMMSS/"
echo ""
echo "📊 Pour comparer avec MobileNetV2 et EfficientNetLite0:"
echo "   python compare_backbones.py"
echo ""
